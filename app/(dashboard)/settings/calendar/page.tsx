              ...
              <AccordionContent className="pt-3 pb-1">
                <div className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5">Calendar OAuth credentials are missing. An administrator can add Google Calendar or Microsoft Outlook Calendar credentials under <strong>Integrations → Calendar</strong>, or set the matching environment variables. OAuth state signing still requires <code className="text-xs">CALENDAR_OAUTH_STATE_SECRET</code> or <code className="text-xs">ENCRYPTION_KEY</code>. See <code className="text-xs">.env.local.example</code>.</p>
                  </div>
                </div>
              </AccordionContent>
            </AccordionItem>
