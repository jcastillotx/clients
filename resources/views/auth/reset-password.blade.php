        ...
        <div class="w-full max-w-md">
            ...
            <div class="rounded-2xl bg-white p-8 shadow-xl">
                <div class="text-center mb-6">
                    <h1 class="text-xl font-semibold text-slate-900">Create new password</h1>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" 
                                   name="email" 
                                   id="email"
                                   class="w-full rounded-xl border border-slate-300 pl-10 pr-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:border-slate-900 focus:ring-1 focus:ring-slate-900 focus:outline-none transition-colors bg-slate-50 @error('email') border-rose-300 focus:border-rose-500 focus:ring-rose-500 @enderror" 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" 
                                   ...
                                   class="w-full rounded-xl border border-slate-300 pl-10 pr-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:border-slate-900 focus:ring-1 focus:ring-slate-900 focus:outline-none transition-colors" 
                                   placeholder="••••••••"
                                   required>
                        </div>
                    </div>
