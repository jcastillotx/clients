                    ...
                    <div class="border-t border-slate-200 pt-5">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" min="0" wire:model.live="discount" class="w-full rounded-xl border border-slate-300 px-3 py-2.5 text-sm text-slate-900 focus:border-slate-900 focus:ring-1 focus:ring-slate-900 focus:outline-none transition-colors disabled:bg-slate-50 disabled:text-slate-500" @disabled(!$editable)>
                                @error('discount')
                                    <div class="mt-1.5 text-xs text-rose-600">{{ $message }}</div>
                                @enderror
                            </div>
