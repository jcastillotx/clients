                ...
                <div class="p-6 space-y-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select wire:model.live="client_id" class="w-full rounded-xl border border-slate-300 px-3 py-2.5 text-sm text-slate-900 bg-white focus:border-slate-900 focus:ring-1 focus:ring-slate-900 focus:outline-none">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select wire:model.live="project_id" class="w-full rounded-xl border border-slate-300 px-3 py-2.5 text-sm text-slate-900 bg-white focus:border-slate-900 focus:ring-1 focus:ring-slate-900 focus:outline-none">
                    ...
                    <div>
                        ...
                        <select wire:model.live="request_id" class="w-full rounded-xl border border-slate-300 px-3 py-2.5 text-sm text-slate-900 bg-white focus:border-slate-900 focus:ring-1 focus:ring-slate-900 focus:outline-none">
                            <option value="">None</option>
                    ...
                    @if($useAiGenerated && $aiHtml)
                        <div class="bg-emerald-50 border border-emerald-200 rounded-xl p-4 mb-4">
                            <div class="flex items-center justify-between">
                                ...
                                <button wire:click="clearAiDraft" class="text-sm text-emerald-600 hover:underline">Clear</button>
                            </div>
                            <p class="text-xs text-emerald-700 mt-1">A PDF will be generated from the AI content when you save.</p>
                        </div>
                    @else
                        <div>
                            <label class="block text-xs font-semibold text-slate-600 mb-1.5">Upload Contract File (PDF, DOC, DOCX)</label>
        ...
        <div class="xl:col-span-1 space-y-6">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                ...
                <div class="p-6 space-y-3 text-sm text-slate-600">
                    ...
                    <div class="flex gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-emerald-500 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                        </svg>
