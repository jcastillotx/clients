    ...
    <div class="card">
        <div class="card-body">
            <div class="form-group">
                ...
                <input class="form-control" wire:model="website_url" placeholder="https://example.com">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" min="1" max="500" class="form-control" wire:model="max_pages">
                        @error('max_pages') <div class="text-danger mt-1">{{ $message }}</div> @enderror
                    </div>
                </div>
                <div class="col-md-4 d-flex align-items-center">
                    <div class="custom-control custom-switch mt-3">
                        <input type="checkbox" class="custom-control-input" id="use_ai" wire:model="use_ai">
