...
<div>
    <div wire:loading.flex class="fixed inset-0 z-50 items-center justify-center bg-slate-900/20 backdrop-blur-sm" aria-label="Loading" style="display:none;">
        <div class="flex items-center gap-3 rounded-xl bg-white px-4 py-3 shadow-lg ring-1 ring-black/5">
            ...
            <span class="text-sm font-medium text-slate-700">Loading invoice…</span>
        </div>
    </div>
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        @if($payable)
            <div class="text-xs text-slate-500" title="Payments are processed securely via Stripe. You’ll receive a receipt after payment.">
                Payments are processed securely via Stripe. You’ll receive a receipt after payment.
            </div>
        @endif
    </div>
